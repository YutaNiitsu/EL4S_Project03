...
public class CharaUI : MonoBehaviour
{
    ...
    [SerializeField] private Player _enemy1;
    [SerializeField] private Player _enemy2;
    ...
    void Update()
    {
        ...
        float enemy1Pos = _enemy1.GetMoveDistance()/*TODO:内部パラメータをもらう*/ * _oneMoveLength + _startPos;
        float enemy2Pos = _enemy2.GetMoveDistance()/*TODO:内部パラメータをもらう*/ * _oneMoveLength + _startPos;
